...
@Component({
  ...
  styles: [
    ...
    `.site-footer{border-top:1px solid var(--border-soft);background:color-mix(in srgb,var(--surface-0) 88%,var(--bg-main) 12%);padding:clamp(20px,4vw,36px) clamp(16px,4vw,40px)}`,
