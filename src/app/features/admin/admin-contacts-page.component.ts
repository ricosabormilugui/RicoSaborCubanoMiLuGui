...
@Component({
  ...
  styles: [
    ...
    `.inbox{max-height:70vh;overflow:auto;border:1px solid #e5e7eb;border-radius:12px;padding:.5rem;background:#f8fafc}`,
    `.contact-item{background:#fff;border:1px solid #e5e7eb;border-radius:10px;padding:.55rem;margin-bottom:.5rem;cursor:pointer}`,
    `.contact-item.active{border-color:#1f4f8f;background:#eef5ff}`,
    ...
    `.detail{border:1px solid #e5e7eb;border-radius:12px;padding:.8rem;background:#fff}`,
    `.detail.empty{display:grid;place-items:center;color:#64748b}`,
    `.meta{color:#64748b;font-size:.85rem}`,
    `.chat{display:grid;gap:.5rem;max-height:48vh;overflow:auto;padding:.6rem;border:1px solid #e5e7eb;border-radius:10px;background:#f8fafc}`,
    `.bubble{background:#fff;border:1px solid #e5e7eb;border-radius:10px;padding:.5rem}`,
    `.bubble.admin{background:#e8f4ff;border-color:#bfdbfe}`,
    `.bubble p{margin:.3rem 0 0;white-space:pre-line}`,
    `.reply-box{display:grid;gap:.5rem;margin-top:.7rem}`,
    `.reply-box textarea{min-height:90px;padding:.6rem;border:1px solid #cfd8e3;border-radius:8px}`,
