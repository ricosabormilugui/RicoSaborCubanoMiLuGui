...
@Component({
  ...
  `,
  styles: [
    `.checkout-shell{display:grid;gap:1rem;padding-bottom:2rem}`,
    `.checkout-hero{display:flex;justify-content:space-between;align-items:flex-start;gap:1rem;background:linear-gradient(135deg,color-mix(in srgb,var(--surface-1) 36%,var(--surface-0) 64%),var(--surface-0))}`,
    `.eyebrow{margin:0;color:var(--accent-green);font-weight:800;text-transform:uppercase;font-size:.8rem;letter-spacing:.04em}`,
    `h1,h2{margin:.1rem 0 .35rem;line-height:1.1}`,
    `.meta,.section-head p,.payment-card small,.payment-summary small{color:var(--text-soft)}`,
    `.status-pill,.pending-note{border:1px solid var(--border-soft);background:var(--surface-1);border-radius:999px;padding:.35rem .7rem;color:var(--text-soft);font-weight:800;white-space:nowrap}`,
    `.checkout-layout{display:grid;grid-template-columns:minmax(0,1fr) minmax(300px,380px);gap:1rem;align-items:start}`,
    `.checkout-form{display:grid;gap:1rem}`,
    `.form-section{display:grid;gap:.8rem;border:1px solid color-mix(in srgb,var(--border-soft) 78%,transparent);border-radius:16px;padding:1rem;background:color-mix(in srgb,var(--surface-0) 84%,var(--surface-1) 16%)}`,
    `.section-head{display:flex;gap:.75rem;align-items:flex-start}`,
    `.section-head span{display:grid;place-items:center;flex:0 0 32px;height:32px;border-radius:50%;background:var(--accent-red);color:var(--on-accent);font-weight:900}`,
    `.section-head p{margin:0;font-size:.94rem}`,
    `.grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:.75rem}`,
    `label{display:grid;gap:.35rem;color:var(--text-main);font-weight:800}`,
    `.phone-input{display:grid;grid-template-columns:minmax(110px,150px) minmax(0,1fr);gap:.5rem}`,
    `.slots{display:grid;gap:.45rem}`,
    `.slots p{margin:0;color:var(--text-main)}`,
    `.slot-buttons{display:flex;gap:.55rem;flex-wrap:wrap}`,
    `.slot-btn{background:var(--surface-1);color:var(--text-main);border:1px solid var(--border-soft);border-radius:999px;padding:.52rem .92rem;cursor:pointer;min-height:40px}`,
    ...
    `.field-error{color:var(--error-text);font-weight:700}`,
    `.consent-check{display:flex;align-items:flex-start;gap:.55rem;font-weight:700;color:var(--text-soft)}`,
    `.consent-check input{margin-top:.2rem;width:18px;height:18px}`,
    `.consent-check a{color:var(--accent-green);font-weight:900}`,
    `.payment-options{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:.7rem}`,
    `.payment-card{display:flex;gap:.6rem;align-items:flex-start;border:1px solid var(--border-soft);border-radius:14px;padding:.8rem;background:var(--surface-1);cursor:pointer}`,
    `.payment-card.active{border-color:var(--accent-green);background:color-mix(in srgb,var(--accent-green) 14%,var(--surface-1))}`,
    `.payment-card input{width:18px;height:18px;margin-top:.15rem}`,
    `.payment-card span{display:grid;gap:.2rem}`,
    `.shipping-quote{border-left:4px solid var(--accent-green);background:var(--surface-1);border-radius:12px;padding:.85rem;color:var(--text-main)}`,
    `.shipping-quote.blocked{border-left-color:var(--error-text)}`,
    `.shipping-quote p{margin:.25rem 0 0;color:var(--text-soft);line-height:1.45}`,
    `.payment-instructions{border-left:4px solid var(--accent-green);background:var(--surface-1);border-radius:12px;padding:.85rem;color:var(--text-main)}`,
    `.payment-instructions p{margin:.3rem 0 0;color:var(--text-soft);line-height:1.45}`,
    `.form-actions{display:flex;justify-content:space-between;align-items:center;gap:.8rem;flex-wrap:wrap}`,
    `.submit-btn{min-height:46px;display:inline-flex;align-items:center;gap:.5rem}`,
    `.spinner{width:18px;height:18px;border:2px solid var(--on-accent);border-top-color:transparent;border-radius:50%;animation:spin .7s linear infinite}`,
    `.summary-card{position:sticky;top:86px;display:grid;gap:.9rem}`,
    `.summary-items{display:grid;gap:.65rem;max-height:42vh;overflow:auto;padding-right:.2rem}`,
    `.summary-item{display:flex;justify-content:space-between;gap:.75rem;border-bottom:1px solid var(--border-soft);padding-bottom:.65rem}`,
    `.summary-item div{display:grid;gap:.2rem;min-width:0}`,
    `.summary-item span{color:var(--text-soft);font-size:.9rem}`,
    `.coupon-box{border:1px solid var(--border-soft);border-radius:12px;padding:.75rem;background:var(--surface-1);display:grid;gap:.35rem}`,
    `.coupon-row{display:grid;grid-template-columns:1fr auto;gap:.5rem}`,
    `.coupon-ok,.summary-line.discount strong{color:var(--ok-text);font-weight:800}`,
    `.summary-line,.summary-total{display:flex;justify-content:space-between;align-items:center;font-size:1rem}`,
    `.summary-line strong{color:var(--text-main)}`,
    `.summary-total strong{color:var(--accent-green);font-size:1.45rem}`,
    `.payment-summary{display:grid;gap:.25rem;border:1px solid var(--border-soft);border-radius:12px;padding:.75rem;background:var(--surface-1)}`,
    `.empty-cart{text-align:center}`,
    `@keyframes spin{to{transform:rotate(360deg)}}`,
    `@media (max-width:980px){.checkout-layout{grid-template-columns:1fr}.summary-card{position:static}.payment-options{grid-template-columns:1fr}.checkout-hero{display:grid}}`,
    `@media (max-width:700px){.grid{grid-template-columns:1fr}.phone-input{grid-template-columns:1fr}.form-section{padding:.85rem}.form-actions{display:grid}.submit-btn{width:100%;justify-content:center}.status-pill,.pending-note{white-space:normal}.summary-item{align-items:flex-start}}`
  ]
})
